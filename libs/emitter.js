...
//
var EmitterParticleSystem = (function () {
    function EmitterParticleSystem() {
    }
    EmitterParticleSystem.prototype.setWorldPosition = function (worldPosition) {
        this.worldPosition = worldPosition;
    };
    EmitterParticleSystem.prototype.createParticle = function (particle) {
        var md = this.md;
    ...
    EmitterParticleSystem.prototype.initialize = function () {
        var md = this.md;
    ...
    EmitterParticleSystem.prototype.update = function (currentTime, deltaTime) {
        var md = this.md;
    ...
    EmitterParticleSystem.prototype.getWorldExtents = function () {
    ...
    EmitterParticleSystem.prototype.destroy = function () {
    };
    /* tslint:enable:no-empty */
    // EmitterParticleSystem Constructor function
    EmitterParticleSystem.create = function (md, gd, parameters) {
    ...
    EmitterParticleSystem.version = 1;
    return EmitterParticleSystem;
})();
EmitterParticleSystem.prototype.indexBuffer = null;
//
//  EmitterParticleSystemRenderer Object
//
var EmitterParticleSystemRenderer = (function () {
    function EmitterParticleSystemRenderer() {
    }
    EmitterParticleSystemRenderer.prototype.update = function (particleSystem, camera) {
    ...
    EmitterParticleSystemRenderer.prototype.updateRenderableWorldExtents = function (particleSystem) {
    ...
    EmitterParticleSystemRenderer.prototype.initialize = function (particleSystem, material, node) {
    ...
    EmitterParticleSystemRenderer.prototype.destroy = function (particleSystems) {
    ...
    EmitterParticleSystemRenderer.create = function (gd, md) {
    ...
    /* tslint:disable:no-unused-variable */
    EmitterParticleSystemRenderer.version = 1;
    return EmitterParticleSystemRenderer;
})();
//
//  Emitter Object
//
